...
export default function AmigosBosque() {
  return (
      ...
      <main className="container mx-auto px-4 py-12">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="mb-8 text-center">
            <h1 className="text-4xl md:text-5xl font-bold text-navy mb-4">Amigos del Bosque</h1>
            <p className="text-lg text-navy/70 italic">
              Una historia sobre la importancia de la amistad y el trabajo en equipo
            </p>
          </div>

          <div className="mb-12 rounded-2xl overflow-hidden shadow-lg">
            <Image
              src="/images/amigos-del-bosque.png"
              alt="Amigos del Bosque"
              width={800}
              height={400}
          ...
          <div className="prose prose-lg max-w-none mb-12">
            <p>
              En el Bosque Claro vivían Lila la liebre, Bruno el oso, Mía la mapache y Leo el búho. Un día, una gran
              tormenta derrumbó su puente de ramas sobre el río.
            </p>

            <p>
              Cada uno intentó construirlo por su cuenta, pero no lograban terminarlo. Entonces, decidieron unir
              fuerzas: Bruno trajo troncos, Lila los ató con lianas, Mía diseñó el camino, y Leo los guiaba desde
              arriba.
            </p>

            <p>
              En menos de un día, el puente estaba listo. Saltaron, rieron y cruzaron juntos. Habían aprendido que
              cuando se trabaja en equipo, ningún problema es demasiado grande.
            </p>
          </div>
          ...
          <div className="bg-teal-light/30 rounded-2xl p-8 mb-12">
            ...
            <p className="text-navy/80 mb-4">
              Este cuento nos enseña sobre la importancia de la amistad y el trabajo en equipo. Los animales del bosque
              descubren que uniendo sus talentos y habilidades pueden superar obstáculos que individualmente parecían
              imposibles.
            </p>
            <p className="text-navy/80">
              La historia nos recuerda que cada uno de nosotros tiene fortalezas únicas que, al compartirlas con los
              demás, pueden crear soluciones creativas y efectivas a los problemas que enfrentamos juntos.
            </p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-navy/70 mb-6">
              Comparte tus pensamientos o dibuja tu propia versión de Amigos del Bosque y envíanosla.
            </p>
            <Link href="/#participa">
