...
export default function LaTortugaYLasEstrellas() {
  return (
      ...
      <main className="container mx-auto px-4 py-12">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="mb-8 text-center">
            <h1 className="text-4xl md:text-5xl font-bold text-navy mb-4">La Tortuga y las Estrellas</h1>
            <p className="text-lg text-navy/70 italic">
              Una historia de perseverancia y amistad bajo el cielo estrellado
            </p>
          </div>

          <div className="mb-12 rounded-2xl overflow-hidden shadow-lg">
            <Image
              src="/images/la-tortuga-y-las-estrellas.png"
              alt="La Tortuga y las Estrellas"
              width={800}
              height={500}
          ...
          <div className="prose prose-lg max-w-none mb-12">
            <p>
              Tina era una pequeña tortuga que soñaba con ver las estrellas desde la cima de la montaña. Sus amigos del
              pantano le decían que era imposible para alguien tan lenta.
            </p>

            <p>
              Pero Tina no se rindió. Cada noche avanzaba un poco, siguiendo la luz de la luna. En el camino conoció a
              Rayo, un zorro veloz, que al ver su esfuerzo decidió acompañarla.
            </p>

            <p>
              Juntos subieron colina tras colina, ayudándose mutuamente. Cuando finalmente llegaron a la cima, el cielo
              brillaba lleno de estrellas.
            </p>

            <p>—¿Lo ves, Tina? —dijo Rayo—. No llegaste sola, pero llegaste.</p>

            <p>
              Y Tina sonrió, porque entendió que los sueños se alcanzan paso a paso, y que con un buen amigo, todo
              camino es más corto.
            </p>
          </div>
          ...
          <div className="bg-teal-light/30 rounded-2xl p-8 mb-12">
            ...
            <p className="text-navy/80 mb-4">
              Este cuento nos enseña sobre la perseverancia y la amistad. Tina nos muestra que con determinación y
              paciencia, podemos alcanzar nuestras metas por muy lejanas que parezcan.
            </p>
            <p className="text-navy/80">
              También nos recuerda que la amistad verdadera puede hacer que cualquier camino difícil sea más llevadero,
              y que a veces, llegar juntos es más importante que llegar primero.
            </p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-navy/70 mb-6">
              Comparte tus pensamientos o dibuja tu propia versión de La Tortuga y las Estrellas y envíanosla.
            </p>
            <Link href="/#participa">
