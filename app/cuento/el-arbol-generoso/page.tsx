...
export default function ElArbolGeneroso() {
  return (
      ...
      <main className="container mx-auto px-4 py-12">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="mb-8 text-center">
            <h1 className="text-4xl md:text-5xl font-bold text-navy mb-4">El Árbol Generoso</h1>
            <p className="text-lg text-navy/70 italic">
              Un cuento sobre la importancia de compartir y cuidar la naturaleza
            </p>
          </div>

          <div className="mb-12 rounded-2xl overflow-hidden shadow-lg">
            <Image
              src="/images/el-arbol-generoso.png"
              alt="El Árbol Generoso"
              width={800}
              height={500}
          ...
          <div className="prose prose-lg max-w-none mb-12">
            <p>
              En un prado tranquilo vivía un árbol frondoso que cada día ofrecía sombra a los animales del bosque. Los
              pájaros construían sus nidos en sus ramas, las ardillas jugaban entre sus hojas, y los niños se sentaban a
              leer bajo su copa.
            </p>

            <p>
              Un verano, llegó una gran sequía. La tierra se secó y los frutos escasearon. Aun así, el árbol no dejó de
              ofrecer lo poco que tenía: una manzana aquí, una hoja para refrescar allá.
            </p>

            <p>Un día, una niña llamada Sol le preguntó: —¿Por qué sigues dando, si tú también lo necesitas?</p>

            <p>
              El árbol respondió con una suave brisa: —Cuando comparto, no me vuelvo menos. Al contrario, crezco por
              dentro.
            </p>

            <p>
              Desde entonces, Sol plantó nuevas semillas, y el bosque entero aprendió que cuidar la naturaleza también
              es dejar que ella nos cuide a nosotros.
            </p>
          </div>
          ...
          <div className="bg-teal-light/30 rounded-2xl p-8 mb-12">
            ...
            <p className="text-navy/80 mb-4">
              Este cuento nos enseña sobre la generosidad y el cuidado de la naturaleza. El árbol nos muestra que
              compartir lo que tenemos no nos hace más pobres, sino más ricos por dentro.
            </p>
            <p className="text-navy/80">
              También nos recuerda la importancia de cuidar nuestro entorno natural, pues al hacerlo, también nos
          ...
          <div className="text-center">
            ...
            <p className="text-navy/70 mb-6">
              Comparte tus pensamientos o dibuja tu propia versión del Árbol Generoso y envíanosla.
            </p>
            <Link href="/#participa">
