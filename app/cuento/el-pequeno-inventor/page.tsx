...
export default function ElPequenoInventor() {
  return (
      ...
      <main className="container mx-auto px-4 py-12">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="mb-8 text-center">
            <h1 className="text-4xl md:text-5xl font-bold text-navy mb-4">El Pequeño Inventor</h1>
            <p className="text-lg text-navy/70 italic">
              Descubre cómo la creatividad puede cambiar el mundo que nos rodea
            </p>
          </div>

          <div className="mb-12 rounded-2xl overflow-hidden shadow-lg">
            <Image
              src="/images/el-pequeno-inventor.png"
              alt="El Pequeño Inventor"
              width={800}
              height={400}
          ...
          <div className="prose prose-lg max-w-none mb-12">
            <p>
              Tomás era un niño curioso que adoraba construir cosas con cartón, tapas y cables viejos. Mientras todos
              jugaban al fútbol, él soñaba con inventar una máquina que hiciera feliz a la gente.
            </p>

            <p>
              Un día, su hermana se enfermó y no podía salir de casa. Tomás construyó un "cuentacuentos automático" que
              proyectaba historias en el techo.
            </p>

            <p>Cuando su hermana lo vio, sonrió por primera vez en días. —¡Gracias, Tomás! —le dijo.</p>

            <p>
              Tomás descubrió que la creatividad no solo sirve para inventar cosas, sino también para hacer del mundo un
              lugar más tierno, divertido… y humano.
            </p>
          </div>
          ...
          <div className="bg-teal-light/30 rounded-2xl p-8 mb-12">
            ...
            <p className="text-navy/80 mb-4">
              Este cuento nos enseña sobre el valor de la creatividad y cómo podemos usarla para mejorar la vida de
              quienes nos rodean.
            </p>
            <p className="text-navy/80">
              La historia de Tomás nos muestra que los inventos más valiosos no son necesariamente los más complejos o
              caros, sino aquellos que nacen del corazón y tienen el poder de hacer sonreír a alguien.
            </p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-navy/70 mb-6">
              Comparte tus pensamientos o dibuja tu propia versión de El Pequeño Inventor y envíanosla.
            </p>
            <Link href="/#participa">
